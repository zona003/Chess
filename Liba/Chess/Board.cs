    ...
    class Board
    {
        ...
        void InitFigures(string data)
        {
            ...
            for (int y = 7; y >= 0; y--)
                for (int x = 0; x < 8; x++)
                {
                    figures[x, y] = (lines[7 - y][x].Equals('.')) ? Figure.none : (Figure)lines[7 - y][x];
                }
        }
        ...
        string FenFigures()
        {
            ...
            string eitgh = "11111111";
            for (int i = 8; i >= 2; i--)
            {
                sb.Replace(eitgh.Substring(0, i), i.ToString());
            }
        ...
        public Board Move(FigureMoving fm)
        {
            ...
            next.SetFigureAt(fm.to, fm.promoution == Figure.none ? fm.figure :  fm.figure);
