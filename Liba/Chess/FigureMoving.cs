...
namespace Chess
{
    class FigureMoving
    {
        ...
        public Figure promoution { get; private set; }

        public FigureMoving(FigureOnSquare fs, Square to, Figure promoution = Figure.none)
        {
            this.figure = fs.figure;
            this.from = fs.square;
            this.to = to;
            this.promoution = promoution;
        }
        ...
        public FigureMoving(string move)
        {
            ...
            this.promoution = (move.Length == 6) ? (Figure)move[5] : Figure.none;
        }
        ...
        public override string ToString()
        {
            ...
            if (promoution != Figure.none)
                text += (char)promoution;
            return text;
        }
